      ...
      <main className="pt-20">
          ...
          <div className="relative z-10 max-w-4xl w-full text-center space-y-10">
            ...
            >
              <div className="flex-1 flex items-center gap-3 px-4 py-3 bg-surface-container-low rounded-2xl w-full">
                ...
                <select className="bg-transparent border-none focus:ring-0 text-on-surface font-medium w-full appearance-none">
              ...
              <button className="bg-primary hover:bg-secondary text-white w-full md:w-auto px-10 py-4 rounded-2xl font-bold transition-all active:scale-95 flex items-center justify-center gap-2">
        ...
        <section className="max-w-7xl mx-auto px-8 py-12 flex flex-col md:flex-row justify-between items-end gap-6">
          <div className="space-y-2">
            ...
            <p className="text-on-surface-variant">Showing 24 properties matching your search in Peshawar</p>
          </div>
            ...
            {hostels.map((hostel) => (
              ...
              >
                ...
                <div className="p-8 space-y-6">
                  ...
                  <button className="w-full bg-tertiary hover:bg-tertiary-container text-white py-4 rounded-full font-bold text-xs uppercase tracking-widest transition-colors active:scale-95">
                    Inquire Now
                  </button>
                </div>
              </motion.div>
